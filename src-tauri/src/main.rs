...
use github::{
    pull_requests::{
        apply_launcher_pr, apply_mods_pr, check_github_api, get_launcher_download_link,
...
use crate::github::pull_requests::download_zip_into_memory;
...
#[tauri::command]
async fn install_git_main(game_install_path: &str) -> Result<String, String> {
